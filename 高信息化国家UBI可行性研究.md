...
2. **但高度信息化 ≠ 免疫治理失败。** 荷兰 toeslagenaffaire（2.6 万家庭被风险算法误判为欺诈，吕特内阁 2021 年总辞）与澳大利亚 Robodebt（违法追债、A$18 亿和解、皇家委员会定性"可耻的失败"）证明：**最数字化的国家在"定向审查"上照样翻车**。这反过来构成 UBI 的治理论点——全民性免资格审查，恰好消除了算法定向的排斥与歧视风险。**UBI 不是治理技术的负担，而是治理技术的减负方案。**
